...
c  Pritingin like this gets through to python dict
      print *, "Principle[3] ", THRVEC(1, 3)
      print *, "Principle[1] ", THRVEC(2, 3)
      print *, "Principle[2] ", THRVEC(3, 3)
      print *, "Major[3] ", THRVEC(1, 2)
      print *, "Major[1] ", THRVEC(2, 2)
      print *, "Major[2] ", THRVEC(3, 2)
      print *, "Minor[3] ", THRVEC(1, 1)
      print *, "Minor[1] ", THRVEC(2, 1)
      print *, "Minor[2] ", THRVEC(3, 1)
      rmax=THRVAL(2)
      rmin=THRVAL(1)      
