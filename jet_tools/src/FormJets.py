...
class Spectral(PseudoJet):
    ...
    def plt_assign_parents(self):
        ...
        fig, ax_arr = plt.subplots(2, int(np.ceil(num_eigdims/2)))
        plt.ion()
        plt.show()
        real_ax = ax_arr[0, 0]
        truth_ax = ax_arr[0, 1]
...
def _run_applyfastjet(input_lines, DeltaR, algorithm_num, program_path="./src/applyFastJet", tries=0):
    """
